...
class Bootstrap_Api extends Am_Module
{
    ...
    public function init()
    {
        ...
        $router->addRoute('api', new Am_Api_RestRouter($this));
    }
...
class Am_Api_RestRouter extends Zend_Controller_Router_Route_Abstract
{
    protected $_module;
    ...
    {
        return null; // cannot be configured from XML
    }
}
